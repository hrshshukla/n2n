  ...
  return (
      <div className="navbar backdrop-blur-sm fig-bold absolute transform translate-x-1/2 z-50 flex items-center justify-between py-1 bg-gray-600/20 h-14 w-1/2 border border-gray-600/30 mx-auto my-10 rounded-full ">
        ...
        <div className="tabs flex items-center w-1/2 justify-end h-full rounded-full gap">
           <Link href='https://github.com/hrshshukla' target='_blank'  className='text-white h-full w-24 rounded-full flex items-center justify-center hover:bg-white/10'> Profile</Link>
           <Link href='https://github.com/hrshshukla/n2n' target='_blank'  className='text-white text- h-full w-32 rounded-full flex items-center justify-between pl-7 pr-1 hover:bg-white/10'> Repo
